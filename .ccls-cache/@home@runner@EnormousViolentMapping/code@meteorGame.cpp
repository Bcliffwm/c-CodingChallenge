/*
  This code contains a function that determines whether an a meteoroid will strike a character's home planet (see edabit for the challenge). The arguments are the meteor's trajectory in a string-form linear equation and a pair of int coords. 
*/
#include <iostream>
